...
const i_env = {
   debug: !!process.env.METACODE_DEBUG,
   server: {
      host: process.env.METACODE_HOST || '127.0.0.1',
      port: parseInt(process.env.METACODE_PORT || '8080'),
      staticDir: process.env.METACODE_STATIC_DIR?i_path.resolve(process.env.METACODE_STATIC_DIR):null,
      httpsCADir: process.env.METACODE_HTTPS_CA_DIR?i_path.resolve(process.env.METACODE_HTTPS_CA_DIR):null,
   },
};
